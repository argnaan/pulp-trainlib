...
# Layer properties
sumnode_connections = [0, 0, 0]           #For Skipnode and Sumnode only, indicates the layer which is connected to

in_ch_list      = [  3,  8, 8*6*6 ]          # Linear: size of input vector
out_ch_list     = [  8,  8, 10 ]            # Linear: size of output vector
